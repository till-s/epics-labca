function lcaClear(pv)
//Release/cleanup (disconnect) channels/PVs
//  Calling Sequence
//lcaClear(pvs)
//  Description
...
//   this call.
//  Parameters
//   pvs: Column vector (in matlab: m x 1 cell- matrix) of m strings.  Alternatively, lcaClear may be called with no rhs argument thus clearing all channels (and monitors).
//  Examples

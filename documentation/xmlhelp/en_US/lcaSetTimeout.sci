function lcaSetTimeout(timeout)
//Set the ezca libary timeout. The total timeout is this value multiplied by the retry count
//  Calling Sequence
//lcaSetTimeout(newTimeout)
//  Description
//   Set the ezca library timeout parameter (consult the ezca

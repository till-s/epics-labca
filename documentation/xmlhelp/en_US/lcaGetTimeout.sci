function [timeout]=lcaGetTimeout()
//Get/set the ezca libary timeout. The total timeout is this value multiplied by the retry count
//  Calling Sequence
//currentTimeout = lcaGetTimeout()
//  Description
//   Retrieve the ezca library timeout parameter (consult the ezca
...
//   timeout multiplied by the <link linkend='lcaGetRetryCount'>retry</link> count.
//  See also
//   lcaSetTimeout
//   lcaGetRetryCount
//   lcaSetRetryCount

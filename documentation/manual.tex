...
\begin{document}
\maketitle
{\hspace*{\fill}{\small\verb$Id: manual.tex,v 1.10 2004/01/03 21:06:55 till Exp $}\hspace*{\fill}}
...
\subsection{ezcaGetControlLimits}
\subsubsection{Calling Syntax}
\begin{verbatim}
...
\subsection{ezcaGetGraphicLimits}
\subsubsection{Calling Syntax}
\begin{verbatim}
...
\subsection{ezcaGetRetryCount, ezcaSetRetryCount}
\subsubsection{Calling Syntax}
\begin{verbatim}
...
\subsection{ezcaGetTimeout, ezcaSetTimeout}
\subsubsection{Calling Syntax}
\begin{verbatim}
...
\subsection{ezcaDebugOn, ezcaDebugOff}
\subsubsection{Calling Syntax}
\begin{verbatim}
ezcaDebugOn()
ezcaDebugOff()
...
\subsection{ezcaSetSeverityWarnLevel}
\label{swarnlevel}
\subsubsection{Calling Syntax}
\begin{verbatim}

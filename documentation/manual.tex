...
\begin{document}
\maketitle
{\hspace*{\fill}{\small\verb$Id: manual.tex,v 1.23 2004/06/22 01:02:53 till Exp $}\hspace*{\fill}}
...
if the data are ready (using \comref{lcaNewMonitorValue()}{lcanewmonitorvalue}).
